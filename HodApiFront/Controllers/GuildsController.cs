...
namespace HodApiFront.Controllers
{
    public class GuildsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GuildId,Name,Icon,Title,MasterPlayerId")] Guild guild)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GuildId,Name,Icon,Title,MasterPlayerId")] Guild guild)
        {
            if (ModelState.IsValid)
            {
